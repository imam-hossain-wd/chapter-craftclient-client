  ...
  const EditBook = () => {
    ...
    const { register, handleSubmit, reset, formState: { errors } } = useForm<IUpdateBook>();
    ...
    const updateBookHandler: SubmitHandler<IUpdateBook> = (data) => {
      const title = data.title;
      const author = data.author;
      const image = data.image[0];
      const genre = data.genre;
    
      // Convert the publication_date to the required format (yyyy-MM-dd)
    ...
    //   console.log(typeof(publication_date));
